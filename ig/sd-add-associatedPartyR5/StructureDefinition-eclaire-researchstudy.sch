...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ResearchStudy">
      ...
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/fhir/eclaire/StructureDefinition/eclaire-approval-date']) &lt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/fhir/eclaire/StructureDefinition/eclaire-approval-date': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/fhir/eclaire/StructureDefinition/eclaire-recruitment-status']) &lt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/fhir/eclaire/StructureDefinition/eclaire-recruitment-status': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:sponsor) &lt;= 0">sponsor: maximum cardinality of 'sponsor' is 0</sch:assert>
      <sch:assert test="count(f:principalInvestigator) &lt;= 0">principalInvestigator: maximum cardinality of 'principalInvestigator' is 0</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:ResearchStudy/f:identifier/f:period</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:ResearchStudy/f:condition</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:ResearchStudy/f:condition/f:coding</sch:title>
    <sch:rule context="f:ResearchStudy/f:condition/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:ResearchStudy/f:contact</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:ResearchStudy/f:period</sch:title>
